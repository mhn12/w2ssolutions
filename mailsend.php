...
<html>
    <head>
		...
		a.switchstyle{ width:184px; height:32px;  position:absolute; top:10px; left:10px; background:transparent url(switchstyle.png) no-repeat top left;}
        </style>
    </head>
    <body>
        <div id="contact">
        ...
        <!-- The JavaScript -->
         <script src="sendmail/javascript/jquery.min.js" type="text/javascript" ></script>
		<script src="sendmail/javascript/jquery.contact.js" type="text/javascript"></script>
    </body>
</html>