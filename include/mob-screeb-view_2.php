<section class="app_features row">
        ...
        <div class="AppAccrodianWrap">
          <div class="PicturesText">
           ...
           <div class="Pictures"> 
          <span class="androidPic1 mobscreen bgadded" data-img="url(/assets/image/location-service-2.png)" style="background:url(_content/index/mob_screen/android-screen-1.png) no-repeat;"></span>
          <span class="androidPic2 mobscreen bgadded" data-img="url(/assets/image/location-service-2.png)" style="background:url(_content/index/mob_screen/android-screen-2.png) no-repeat;"></span>
          <span class="androidPic3 mobscreen bgadded" data-img="url(/assets/image/location-service-2.png)" style="background:url(_content/index/mob_screen/android-screen-3.png) no-repeat;"></span>
          <span class="androidPic4 mobscreen bgadded" data-img="url(/assets/image/location-service-2.png)" style="background:url(_content/index/mob_screen/android-screen-4.png) no-repeat;"></span>
          <span class="androidMob mobscreen bgadded" data-img="url(/assets/image/location-service-2.png)" style=" background:url(_content/index/mob_screen/mob_andoid-screen-5.png) no-repeat;"></span> 
          </div>
